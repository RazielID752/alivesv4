...
export function ProjectCard({ project, index }: ProjectCardProps) {
  const projectHref = project.caseSlug
    ? `/cases/${project.caseSlug}`
    : project.projectUrl;
  ...
  return (
    <article className="group overflow-hidden rounded-[1.5rem] border border-zinc-950/10 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.08)] transition duration-300 hover:-translate-y-2">
      <Link
        className="block focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-4 focus:ring-offset-zinc-50"
        href={projectHref}
      ...
      <div className="p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Button href={projectHref} icon={ExternalLink}>
            Ver case
          </Button>
